...
// --- Intro splash: only play once per browser session ---
const loadingPage = document.querySelector('.loading-page');
const introSeen = sessionStorage.getItem('graff_intro_seen');

if (introSeen) {
    // Skip straight to hidden — no animation, no delay, no flash on back/forward nav
    ...
    sessionStorage.setItem('graff_intro_seen', 'true');
}